...
def LoginForm():
    ...
    lbl_text = Label(TopLoginForm, text="GARUDA Admin Log-In", font=('arial', 18,), width=600, bg ='#1877f2', fg= '#ffffff')
...
'''button1 = Button(root, font=('arial', 14, 'bold'), width='11', height='4', bd='0', text='1', bg='black', fg='yellow',command=lambda :ShowLoginForm() )
...
def Home():
    ...
    Title.pack(pady=10)
    lbl_display = Label(Title, text="GARUDA INVENTORY MANAGEMENT", font=('arial', 35))
    lbl_display.pack()
    menubar = Menu(Home)
    ...
    button1 = Button(root, font=('arial', 14, 'bold'), width='11', height='4', bd='0', text='1', bg='black',
                     fg='yellow', command=lambda: ShowLoginForm())
...
def ShowAddItem():
    ...
    additemform.title("GARUDA INVENTORY MANAGEMENT/Add Item")
    width = 600
    height = 400
    screen_width = Home.winfo_screenwidth()
    screen_height = Home.winfo_screenheight()
...
def Delete():
    if not tree.selection():
       print("ERROR")
        ...
        result = tkMessageBox.askquestion('GARUDA INVENTORY MANAGEMENT', 'Are you sure you want to delete this record?', icon="warning")
        if result == 'yes':
            curItem = tree.focus()
...
def ShowSale():
    global saleform
    saleform = Toplevel()
    saleform.title("GARUDA INVENTORY MANAGEMENT/Sale")
    width = 600
    height = 400
    screen_width = Home.winfo_screenwidth()
    screen_height = Home.winfo_screenheight()
...
def Logout():
    result = tkMessageBox.askquestion('GARUDA INVENTORY MANAGEMENT', 'Are you sure you want to logout?', icon="warning")
    if result == 'yes': 
        admin_id = ""
        root.deiconify()
        Home.destroy()
